...
public class DatabaseLoader implements CommandLineRunner {
	...
	public void run(String... args) {
		 ...
		 * links.
		 * put("Tutorial series about building microservices with SpringBoot (with Netflix OSS)"
		 * ,
		 ...
		 * ); links.
		 * put("Simplest way to Upload and Download Files in Java with Spring Boot - Code to download from Github"
		 * ,
