...
public class DatabaseLoader implements CommandLineRunner {
    ...
    private void addComment() {
        ...
        for (Link link : linkList) {
			...
			Comment comment1 = new Comment("Thank you for this link related to Spring Boot. I love it, great post!", link);
			Comment comment2 = new Comment("I love that you're talking about Spring Security", link);
			Comment comment3 = new Comment("What is this Progressive Web App thing all about? PWAs sound really cool.", link);
